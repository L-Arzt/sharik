...
export const metadata: Metadata = {
  title: 'ШарикиРостов.рф - Воздушные шары в Ростове-на-Дону и Аксае | Заказать шары',
  description: 'Воздушные шары в Ростове-на-Дону и Аксае! Шарики для дня рождения, свадьбы, корпоративов. Качественные шары по доступным ценам. Доставка по городу от 4000₽. Самовывоз в центре.',
  ...
  openGraph: {
    title: 'ШарикиРостов.рф - Воздушные шары в Ростове-на-Дону и Аксае | Заказать шары',
    description: 'Воздушные шары в Ростове-на-Дону и Аксае! Качественные шары по доступным ценам. Доставка по городу от 4000₽.',
    type: 'website',
    locale: 'ru_RU',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Воздушные шары в Ростове-на-Дону и Аксае - ШарикиРостов.рф',
      },
    ],
  },
  twitter: {
    ...
    description: 'Воздушные шары в Ростове-на-Дону и Аксае! Качественные шары по доступным ценам.',
    images: ['/og-image.jpg'],
  },
  robots: {
    index: true,
