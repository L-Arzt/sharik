...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white -mt-px " itemScope itemType="https://schema.org/Organization">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-600 rounded-full flex items-center justify-center text-white hover:shadow-lg transition-shadow"
              >
